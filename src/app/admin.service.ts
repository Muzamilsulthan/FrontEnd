...
getLoggedInTeamMemberId(): number | null {
  ...
  updateTask(task:Task): Observable<void> {
    return this.http.put<void>(`${this.apiUrl}/teammember/updatetasks/${task.id}`, task);
  }
  ...
  getProjectmamangerById(id:number):Observable<ProjectManager> {
    return this.http.get<ProjectManager>(`${this.apiUrl}/admin/editProjectmanager/${id}`);
  }

  updateProjectmanager(projectmanager:ProjectManager):Observable<void> {
    return this.http.put<void>(`${this.apiUrl}/admin/updateprojectmanager/${projectmanager.id}`, projectmanager);
  }



  deleteProjectManager(id:number): Observable<any> {
    return this.http.delete(`${this.apiUrl}/admin/deleteprojectmanager/${id}`);
  }
